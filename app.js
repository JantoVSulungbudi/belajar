...
var createScene = function () {
  ...
  //parameters - arrayOfMeshes, disposeSource, allow32BitsIndices,
  //meshSubclass, subdivideWithSubMeshes, multiMultiMaterial
  var mesh = BABYLON.Mesh.MergeMeshes([sphere, cube], true, true, undefined, false, true);
  mesh.position = new BABYLON.Vector3(4, 0, 0);
...
var animationSpeed = 0.01; // Speed of the movement
